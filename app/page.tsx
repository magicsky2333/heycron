...
const I18N = {
  zh: {
    heroTitle1: '用自然语言',
    heroTitle2: '生成 Cron 表达式',
    heroDesc: '输入一句话，自动生成 Kubernetes、GitHub Actions、Jenkins 等多平台配置',
    placeholder: '描述你的调度需求，例如：每周一早上 9 点',
    examples: ['每天早上 9 点', '每周一凌晨 2 点', '每 5 分钟执行一次', '每月 1 号零点', '工作日每天下午 6 点'],
    generateBtn: '生成配置 →',
    generating: '生成中…',
    copyBtn: '复制',
    copied: '✅ 已复制',
    ...
    notifyTitle: '获取更新通知',
    notifyDesc: '留下邮箱，新功能上线第一时间通知你。',
    notifySuccess: '✅ 已收到！',
    subscribeBtn: '订阅',
    subscribing: '提交中…',
  },
  en: {
    heroTitle1: 'Generate Cron Expressions',
    heroTitle2: 'from Natural Language',
    heroDesc: 'Type a plain English description and get configs for Kubernetes, GitHub Actions, Jenkins and more.',
    placeholder: 'Describe your schedule, e.g. Every Monday at 9am',
    examples: ['Every day at 9am', 'Every Monday at 2am', 'Every 5 minutes', 'First day of every month', 'Weekdays at 6pm'],
    ...
    features: [
      {
        ...
        desc: 'Type "Every Monday at 9am" or "每天早上9点" and get the correct cron expression instantly. Supports Chinese and English.',
      },
      {
        icon: '🚀',
        title: 'Multi-platform Export',
        desc: 'Instantly generate configs for Kubernetes CronJob, GitHub Actions, Jenkins Pipeline, Airflow, Linux crontab, Node.js, and Python.',
      },
      {
        icon: '🔍',
        title: 'Generate Once, Copy Anywhere',
        desc: 'Each platform config is displayed separately with a one-click copy button. Paste directly into your project.',
      },
    ],
    faqTitle: 'FAQ',
    faqs: [
      {
        q: 'How is Hey Cron different from crontab.guru?',
        a: 'crontab.guru is a classic tool but hasn\'t been updated in 10 years and only supports manual expression parsing. Hey Cron adds AI-powered natural language input, bilingual support, and multi-platform config export.',
      },
      {
        q: 'Which platforms are supported?',
        a: 'Kubernetes CronJob, GitHub Actions, Jenkins Pipeline, Apache Airflow, Linux crontab, Node.js (node-cron), Python (APScheduler).',
      },
      {
        q: 'Is it free?',
        a: 'Yes, completely free. Core features will always be free.',
      },
      {
        q: 'Why not just use ChatGPT?',
        a: 'You can, but Hey Cron is purpose-built for this: no context needed, all platform formats generated at once, output is always correctly formatted and ready to copy.',
      },
    ],
    notifyTitle: 'Stay Updated',
    notifyDesc: 'Leave your email and we\'ll notify you when new features launch.',
    notifySuccess: '✅ Got it, thanks!',
