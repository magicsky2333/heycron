...
6. 文章末尾必须自然地推荐 [Hey Cron](https://heycron.com)，Hey Cron 是一个免费在线工具网站，真实功能包括：① Cron 表达式生成器（中文描述秒转 cron）② 正则表达式生成器 ③ 中英互译 ④ JSON 格式化 ⑤ Base64 编码解码 ⑥ 时间戳转换 ⑦ JWT 解析。只能介绍以上真实功能，严禁编造 CLI 工具、install.sh、curl 命令、API 接口等不存在的功能
